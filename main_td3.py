...
def main():
    ...
    td3_agent=TD3_AGENT(LR_A,LR_C,STATE_dim,TAU,Action_max,GAMMA,update_actor_interval=2,n_actions=Action_dim,max_size=MEMORY_CAPACITY,batch_size=BATCH_SIZE)
    ...
    for i in range(MAX_EPISODES):
        ...
        while done!=True:
            ...
            action=td3_agent.choose_action(np.array(state))
